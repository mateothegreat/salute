...
@Component({
    ...
    template: `
        <div (mouseover)="notification.pausible ? notification.timer?.pause() : null"
             ...
             [style.color]="notification.theme.color"
             class="salute-notification">

            <div class="salute-notification-content">
                <div class="salute-notification-top">
                    <div class="salute-notification-left">
                        <svg *ngIf="notification.level === 'INFO'" viewBox="0 0 24 24"
                        ...
                        <svg *ngIf="notification.level === 'ERROR'" viewBox="0 0 24 24"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="m21.25 0h-18.5c-1.517 0-2.75 1.233-2.75 2.75v18.5c0 1.517 1.233 2.75 2.75 2.75h18.5c1.517 0 2.75-1.233 2.75-2.75v-18.5c0-1.517-1.233-2.75-2.75-2.75z"
                        ...
                        <svg *ngIf="notification.level === 'WARNING'" viewBox="0 0 24 24"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="m21.25 0h-18.5c-1.517 0-2.75 1.233-2.75 2.75v18.5c0 1.517 1.233 2.75 2.75 2.75h18.5c1.517 0 2.75-1.233 2.75-2.75v-18.5c0-1.517-1.233-2.75-2.75-2.75z"
                                style="fill: rgb(244, 163, 65);"/>
                            <path d="m12 19c-.552 0-1-.447-1-1s.448-1 1-1 1 .447 1 1-.448 1-1 1z" fill="#fafafa"/>
                            <path d="m13 14c0 .553-.448 1-1 1s-1-.447-1-1v-8c0-.553.448-1 1-1s1 .447 1 1z"
                                  fill="#fafafa"/>
                            <path
                                d="m12 0h-9.25c-1.517 0-2.75 1.233-2.75 2.75v18.5c0 1.517 1.233 2.75 2.75 2.75h9.25v-5c-.552 0-1-.447-1-1s.448-1 1-1v-2c-.552 0-1-.447-1-1v-8c0-.553.448-1 1-1z"
                        ...
                        <svg *ngIf="notification.level === 'SUCCESS'" viewBox="0 0 24 24"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    <div *ngIf="notification.title"
                         [style.color]="notification.theme.title.color"
                         [style.font-size]="notification.theme.title.fontSize"
                         [style.font-weight]="notification.theme.title.fontWeight"
                         class="salute-notification-title">
                        {{ notification.title }}
                    </div>
                    <div class="salute-notification-close"
                         [style.color]="'lightgray'"
                         [style.opacity]="notification.theme.closeOpacity">
